# Generated by Django 5.0.4 on 2025-02-20 10:32
...
def create_unique_brands(apps, schema_editor):
    ...
    for brand_name in unique_brands_names:
        unique_brands.objects.using(db_alias).create(brand=brand_name)
...
class Migration(migrations.Migration):
    ...
    operations = [ migrations.RunPython(create_unique_brands),
    ]
