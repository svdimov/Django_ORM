# Generated by Django 5.0.4 on 2025-03-22 16:13
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('authors', models.ManyToManyField(related_name='articles_authors', to='main_app.author')),
            ],
        ),
        migrations.CreateModel(
            name='Review',
            fields=[
                ...
                ('published_on', models.DateTimeField(auto_now_add=True)),
                ('article', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews_articles', to='main_app.article')),
                ('author', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reviews_authors', to='main_app.author')),
            ],
        ),
    ]
